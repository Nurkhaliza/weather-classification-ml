...
if model_option == "Logistic Regression":
    ...
    # Tambahan: Training vs Validation Accuracy
    st.write("**6️⃣b Model Training Performance:**")
    ...
    fig.patch.set_facecolor('white')
    colors_perf = [RED_TO_GOLD[4], RED_TO_GOLD[2]]
    ax.bar(perf_data['Dataset'], perf_data['Accuracy'], color=colors_perf, alpha=0.6, edgecolor=PRIMARY_COLOR, width=0.5)
    ax.set_ylabel('Accuracy', fontweight='bold')
    ax.set_title('Training vs Testing Accuracy - XGBoost', fontweight='bold', color=PRIMARY_COLOR)
    ax.set_ylim([0, 1])
